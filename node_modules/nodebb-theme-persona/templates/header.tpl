...
<head>
	...
	<link rel="stylesheet" href="{relative_path}/customCSS.css" type="text/css">
...
<body class="{bodyClass} skin-{config.bootswatchSkin}" style="padding-top: 0px">
	...
	<main id="panel" style="padding-top: 0px">
		<nav style="position: relative; margin: 0;" class="navbar navbar-default navbar-fixed-top header" id="header-menu" component="navbar">
			<div class="container-fluid hidden-xs">
				<a href="/home"><img style=" height: 60px" src="/images/swcmilog.png" alt=""></a>
