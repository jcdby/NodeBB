			<div class="navbar-header hidden-lg">
				...
				<a href="{relative_path}/">
					<h1 class="navbar-brand forum-title visible-xs">{title}</h1>
				</a>
			...
			<div id="nav-dropdown" class="hidden-xs">
				...
				<!-- ELSE -->
				<ul id="logged-out-menu" class="nav navbar-nav navbar-right" style="margin-right: -15px;">
				...
				<ul id="main-nav" class="nav navbar-nav">
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="/churchIntro">수원선교교회는</a></li>
							<li><a href="/churchVision">교회비전</a></li>
							<li class="divider"></li>
							<li><a href="/servants">섬기는 사람들</a></li>
							<li><a href="/serviceTime">예배시간</a></li>
							<li class="divider"></li>
							<li><a href="/roads">오시는 길</a></li>
						</ul>
					</li><li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">말씀 <span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu">
						<li><a href="/category/9/주일설교">주일설교</a></li>
						<li><a href="/category/6/성경공부">성경공부</a></li>
					</ul>
				</li><li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">교회학교 <span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu">
						<li><a href="/children">유초등부</a></li>
						<li><a href="/jebs">JEBS</a></li>
						<li><a href="/middle">중고등부</a></li>
						<li><a href="/ajoucmi">대학부(아주대CMI)</a></li>
						<li><a href="/engsch">영어성경</a></li>
					</ul>
				</li><li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">셀모임 <span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu">
						<li><a href="/silver">실버셀</a></li>
						<li><a href="/vision">비전셀</a></li>
						<li><a href="/maria">마리아셀</a></li>
						<li><a href="/daniel">다니엘셀</a></li>
						<li><a href="/broom">로뎀셀</a></li>
						<li><a href="/david">다윗셀</a></li>
						<li><a href="/green">푸른초장셀</a></li>
						<li><a href="/joseph">요셉셀</a></li>
					</ul>
				</li><li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">선교 <span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu">
						<li><a href="/missionary">선교</a></li>
						<li><a href="/category/3/선교-편지">선교편지</a></li>
					</ul>
				</li>
					<!-- BEGIN navigation -->
